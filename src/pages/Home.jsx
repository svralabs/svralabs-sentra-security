    ...
    <div className="bg-background selection:bg-primary/20">
        ...
        <section className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          ...
          <div className="flex flex-wrap gap-3 mb-16 animate-on-scroll" style={{transitionDelay: '100ms'}}>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full glass-card border-white/5">
              <span className="material-symbols-outlined text-[18px] text-neutral-400">speed</span>
              <span className="font-label-mono text-caption uppercase tracking-wider text-neutral-300">Setup in minutes</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full glass-card border-white/5">
              <span className="material-symbols-outlined text-[18px] text-neutral-400">monitoring</span>
              <span className="font-label-mono text-caption uppercase tracking-wider text-neutral-300">Track anomalies</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full glass-card border-white/5">
              <span className="material-symbols-outlined text-[18px] text-neutral-400">security</span>
              <span className="font-label-mono text-caption uppercase tracking-wider text-neutral-300">Zero Trust Access</span>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 rounded-full glass-card border-white/5">
              <span className="material-symbols-outlined text-[18px] text-neutral-400">hub</span>
              <span className="font-label-mono text-caption uppercase tracking-wider text-neutral-300">Global Mesh</span>
            </div>
          </div>
          {/* 2. Hero Content */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-on-scroll" style={{transitionDelay: '200ms'}}>
              ...
              <div className="flex items-center gap-8 border-t border-white/10 pt-8">
                <div>
                  ...
                  <div className="font-label-mono text-caption text-neutral-500 uppercase tracking-widest">Developers</div>
                </div>
                <div className="h-10 w-px bg-white/10"></div>
                <div>
                  <div className="font-headline-md text-headline-md text-primary font-bold">99.99%</div>
                  <div className="font-label-mono text-caption text-neutral-500 uppercase tracking-widest">Uptime</div>
                </div>
              </div>
            </div>
            <div className="relative animate-on-scroll" style={{transitionDelay: '400ms'}}>
              <div className="aspect-square rounded-card overflow-hidden border-gradient relative">
                <img className="w-full h-full object-cover grayscale brightness-110" alt="A futuristic, high-end abstract 3D render of a crystalline security node glowing with white inner light against a deep obsidian void background. The style is hyper-modern and technical, featuring sharp geometric edges and soft caustic light refractions. The image conveys a sense of impenetrable digital protection and high-speed data processing with subtle monospaced text overlays in the corners." src="https://lh3.googleusercontent.com/aida-public/AB6AXuB9SS-TzdVR8Va77IQ_VNetHvdyEukA1dn5j9oBonSnjbGYp6P35JuNJyTyY7TKLFt9uLgwpv17Jehp_u8qtign3J1WJIXI_nCcn0ApXjEzdzxYHiEtKIim8bxozlNMuAiJl8oyLD7NeepsMqY7uJVHoetemjb7-fqENehv3ZEYc6poCPUuuScbWTxo08VqYaU9yGebFyqI2blHNplo3si9IwWlmqytVt8-eNW1Q06EfXlfgcB5JXOp"/>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter mt-section-gap">
            <div className="group relative aspect-[16/9] md:aspect-auto md:h-[400px] rounded-card overflow-hidden border-gradient animate-on-scroll" style={{transitionDelay: '500ms'}}>
              <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105" style={{backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAfr7Q67yoZ9q2H73YODpHwbTh0i_plTR9dQLu_LIIe7psiPMF0Uf2Du1gIckgn6DeLBMQ6zDT_jwRSfcoPtwMutDNi-_h_dpvuE9V5ntepDIzz_zzFo9MCNP__lDt0CPWEYpHOfStAGl0wqFv4SynvwFBSj1lXguFrdiQPcPNgwJKheqJRCO606O4Y5cX2JytixjeScvKnRV1DLBCPaWFted_nS8JXEFBphT9-q_OgG_DxHrvaAAgd')"}}></div>
              ...
              <div className="absolute bottom-0 left-0 p-10">
                ...
                <p className="font-body-md text-body-md text-on-surface-variant max-w-sm">
                  Connect any device, anywhere, to your secure backbone with zero latency and absolute encryption.
                </p>
              </div>
            </div>
            <div className="group relative aspect-[16/9] md:aspect-auto md:h-[400px] rounded-card overflow-hidden border-gradient animate-on-scroll" style={{transitionDelay: '600ms'}}>
              <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105" style={{backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD8BXy-IziKDjXA_AjcHEA__vCpAPnB-uP8_Ul9N_feRi0hzu0og5E6aNYqFr3F_UBAbwhHpoD9DWs9mRu6EGDoVRC1zZnnxkTlAkqiz04OBuLotbjRK2CZ_u-yjuj003cdF8tnqJypWmSIoIjULMC8DlLXRyCUV5SXjVfTMWPhTDGime1VOBHdD6CFc3htA_dYaV0AR81zoSyJV1zx91wZkrxdA_IeSmz_o9ZxHXyYUtsUGG9oL0rH')"}}></div>
              <div className="absolute inset-0 bg-gradient-to-t from-background to-transparent opacity-80"></div>
              <div className="absolute bottom-0 left-0 p-10">
                <h3 className="font-headline-md text-headline-md text-primary mb-4">Real-time Forensics</h3>
                <p className="font-body-md text-body-md text-on-surface-variant max-w-sm">
                  Instant visibility into every packet and permission. Resolve threats before they become incidents.
                </p>
              </div>
            </div>
          </div>
      ...
      <footer className="w-full py-gutter px-margin-mobile md:px-margin-desktop flex flex-col md:flex-row justify-between items-center mt-section-gap border-t border-white/10 bg-surface">
        <div className="flex flex-col md:flex-row items-center gap-8 mb-6 md:mb-0">
          ...
          <span className="font-caption text-caption text-on-surface-variant">© 2024 Sentra Security. All rights reserved.</span>
        </div>
        <div className="flex gap-6">
          ...
          <a className="font-caption text-caption text-on-surface-variant hover:text-primary transition-colors" href="#">Security Architecture</a>
          <a className="font-caption text-caption text-on-surface-variant hover:text-primary transition-colors" href="#">Status</a>
        </div>
      </footer>
    </div>
  );
